...
import os
os.chmod('/Users/baaghi/Desktop/WhatsappBOT-master/chromedriver', 755)

now = datetime.now()

#driver = webdriver.Chrome(executable_path="/Users/baaghi/Desktop/WhatsappBOT-master/chromedriver copy")
...
def blueSelection(event=None):
    ...
    def Driver():
        ...
        if len(str(phone_number)) != 12:
            ...
            driver = webdriver.Chrome(executable_path="/Users/baaghi/Desktop/WhatsappBOT-master/chromedriver", options=options)
